...
projects = [
    {
        "name": "송도 11-1공구",
        "gen": str(_BASE / "output" / "E공구 기반시설 건설공사 (1-1구역) 현장" / "02_귀책분석_E공구 기반시설 건설공사 (1-1구역) 현장_20260409.docx"),
        "ref": str(_BASE / "reference" / "송도 11-1공구 기반시설 건설공사(1-1구역)_공기연장 간접비 산정 보고서_260309.docx"),
    },
    {
        "name": "C공구(철도)",
        "gen": str(_BASE / "output" / "C공구(철도) 노반신설 기타공사" / "02_귀책분석_C공구(철도) 노반신설 기타공사_20260409.docx"),
        "ref": str(_BASE / "reference" / "C공구(철도)_공기연장 간접비 산정 보고서_260317.docx"),
    },
    {
        "name": "D공구 2공구",
        "gen": str(_BASE / "output" / "D공구-오산 천연가스 공급설비 건설공사 2공구" / "02_귀책분석_D공구-오산 천연가스 공급설비 건설공사 2공구_20260409.docx"),
        "ref": str(_BASE / "reference" / "D공구~오산 제2공구 천연가스 공급시설 건설공사 공기연장 간접비 보고서_260318.docx"),
    },
]
