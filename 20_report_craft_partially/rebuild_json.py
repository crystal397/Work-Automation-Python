...
items = [
    # ─ 1. 도로관리심의 신청 1/4분기
    {
        "no": 1,
        "date": "2024.01.19.",
        "doc_number": "A건설(C공구) 제2024-0008호",
        "subject": "도로관리심의회 심의 신청 요청(C공구(철도) 제5공구) — 1/4분기",
        "sender": "계약상대자",
    ...
    # ─ 2. 한전주 이설 요청
    {
        "no": 2,
        "date": "2024.01.29.",
        "doc_number": "A건설(C공구) 제2024-0010호",
        "subject": "한전주 이설 요청(C공구(철도) 5공구)",
        "sender": "계약상대자",
    ...
    # ─ 3. 문화재_B 문화재 현상변경 허가
    {
        ...
        "subject": "경기도 지정문화재(문화재_B) 현상변경 허가 알림(C공구(철도) 복선전철 5공구 공사)",
        "sender": "지자체",
    ...
    # ─ 4. 1/4분기 심의결과 알림 (발주자→건설사업관리단) — 구 no.4 분리
    {
        "no": 4,
        "date": "2024.03.19.",
        "doc_number": "발주처사업단(수도권)-4703",
        "subject": "1분기 도로관리심의 결과 알림",
        "sender": "발주자",
        "sender_full": "발주처(철도) 수도권본부장",
        "receiver": "건설사업관리단",
        "receiver_full": "C공구(철도) 제5,6공구 감리단",
        "show_in_table": True,
        "event_type": "인허가",
        "causal_party": "발주처",
    ...
    # ─ 5. 1/4분기 심의결과 알림 (건설사업관리단→계약상대자) — 구 no.4 포워딩
    {
        "no": 5,
        "date": "2024.03.19.",
        "doc_number": "감리단(C공구) 제2024-0062호",
        "subject": "1분기 도로관리심의 결과 알림(C공구(철도) 5,6공구)",
        "sender": "건설사업관리단",
        "sender_full": "C공구(철도) 제5,6공구 감리단장",
        "receiver": "계약상대자",
        "receiver_full": "C공구(철도) 현장대리인",
        "show_in_table": True,
        "event_type": "인허가",
        "causal_party": "발주처",
        "causal_description": "감리단(C공구) 제2024-0062호(2024.03.19.)에 의거, 건설사업관리단이 발주처사업단(수도권)-4703호(2024.03.19.)에 따른 2024년 1/4분기 도로관리심의회 심의 결과를 계약상대자에게 공식 전달하였다.",
        "delay_days": 0,
        "note": "발주처사업단(수도권)-4703호 전달",
    },
    # ─ 6. 도로관리심의 신청 2/4분기 — 구 no.5
    {
        "no": 6,
        "date": "2024.03.19.",
        "doc_number": "A건설(C공구) 제2024-0028호",
        "subject": "도로관리심의회 심의 신청 요청(C공구(철도) 제5공구) — 2/4분기",
        "sender": "계약상대자",
    ...
    # ─ 7. 문화재_A 문화재 허가 (발주자→건설사업관리단) — 구 no.6 분리
    {
        "no": 7,
        "date": "2024.04.18.",
        "doc_number": "발주처사업단(신안산선)-192",
        "subject": "문화재 현상변경 허가 알림(C공구(철도), 문화재_A)",
        "sender": "발주자",
        "sender_full": "발주처(철도) 수도권본부장",
        "receiver": "건설사업관리단",
        "receiver_full": "C공구(철도) 제5,6공구 감리단",
    ...
    # ─ 8. 문화재_A 문화재 허가 (건설사업관리단→계약상대자) — 구 no.6 포워딩
    {
        "no": 8,
        "date": "2024.04.19.",
        "doc_number": "감리단(C공구) 제2024-0167호",
        "subject": "문화재 현상변경 허가 알림(C공구(철도), 문화재_A)",
        "sender": "건설사업관리단",
        "sender_full": "C공구(철도) 제5,6공구 감리단장",
        "receiver": "계약상대자",
        ...
        "causal_party": "발주처",
        "causal_description": (
            "감리단(C공구) 제2024-0167호(2024.04.19.)에 의거, 건설사업관리단이 "
            "발주처사업단(신안산선)-192호(2024.04.18.)에 따른 수원 광주이씨고택 문화재 "
            "현상변경 허가 결과를 계약상대자에게 공식 전달하였다. 이로써 계약상대자는 "
            "해당 구간 공사착수 전 문화재 허가조건 이행 의무를 부과받았다."
        ),
        "delay_days": 0,
        "note": "발주처사업단(신안산선)-192 전달 / 허가번호 제2024-0551호",
    },
    # ─ 9. 도로점용허가 신청 — 구 no.7
    {
        "no": 9,
        "date": "2024.04.26.",
        "doc_number": "A건설(C공구) 제2024-0053호",
        "subject": "106정거장 및 환기구7번 도로점용허가 신청 요청(C공구(철도) 제5공구)",
        "sender": "계약상대자",
    ...
    # ─ 10. 도로점용허가 완료 (발주자→건설사업관리단) — 구 no.8 분리
    {
        "no": 10,
        "date": "2024.05.30.",
        "doc_number": "발주처사업단(신안산선)-3743",
        "subject": "도로점용허가 완료알림(C공구(철도), 환기구 7번/106정거장)",
        "sender": "발주자",
        "sender_full": "발주처(철도) 수도권본부장",
        "receiver": "건설사업관리단",
        "receiver_full": "C공구(철도) 제5,6공구 감리단",
    ...
    # ─ 11. 도로점용허가 완료 (건설사업관리단→계약상대자) — 구 no.8 포워딩
    {
        "no": 11,
        "date": "2024.05.31.",
        "doc_number": "감리단(C공구) 제2024-0296호",
        "subject": "도로점용허가 완료알림(C공구(철도), 환기구 7번/106정거장)",
        "sender": "건설사업관리단",
        "sender_full": "C공구(철도) 제5,6공구 감리단장",
        "receiver": "계약상대자",
        ...
        "causal_party": "발주처",
        "causal_description": (
            "감리단(C공구) 제2024-0296호(2024.05.31.)에 의거, 건설사업관리단이 "
            "발주처사업단(신안산선)-3743호(2024.05.30.)에 따른 환기구 7번 및 106정거장 "
            "도로점용허가 완료 사실을 계약상대자에게 공식 전달하였다."
        ),
        "delay_days": 0,
        "note": "발주처사업단(신안산선)-3743 전달 / 허가번호 제2024-48호",
    },
    # ─ 12. 한전 시설부담금 청구 — 구 no.9
    {
        ...
        "subject": "배전선로 이설공사 시설부담금 청구 [C공구(철도) 제5공구 106정거장 공사]",
        "sender": "관계기관(전력)",
    ...
    # ─ 13. 이설공사비 지급 완료 (발주자→건설사업관리단) — 구 no.11 분리
    {
        "no": 13,
        "date": "2024.10.04.",
        "doc_number": "발주처사업단(철도)TF-2851",
        "subject": "지장물 이설 공사비 지급 완료 알림(C공구(철도), 관계기관(전력))",
        "sender": "발주자",
        "sender_full": "발주처(철도) 수도권본부장",
        "receiver": "건설사업관리단",
        "receiver_full": "C공구(철도) 제5,6공구 감리단",
    ...
    # ─ 14. 이설공사비 지급 완료 (건설사업관리단→계약상대자) — 구 no.11 포워딩
    {
        "no": 14,
        "date": "2024.10.04.",
        "doc_number": "감리단(C공구) 제2024-0904호",
        "subject": "지장물 이설 공사비 지급 완료 알림(C공구(철도), 관계기관(전력))",
        "sender": "건설사업관리단",
        "sender_full": "C공구(철도) 제5,6공구 감리단장",
        "receiver": "계약상대자",
        ...
        "causal_party": "발주처",
        "causal_description": (
            "감리단(C공구) 제2024-0904호(2024.10.04.)에 의거, 건설사업관리단이 "
            "발주처사업단(철도)TF-2851호(2024.10.04.)에 따른 관계기관(전력) 지장물 "
            "이설공사비 지급 완료 사실을 계약상대자에게 공식 전달하였다."
        ),
        "delay_days": 0,
        "note": "발주처사업단(철도)TF-2851 전달",
    },
    # ─ 15. 제1차 1회 준공기한 연장 계약변경 요청 — 구 no.14
    {
        "no": 15,
        "date": "2024.11.27.",
        "doc_number": "A건설(C공구) 제2024-0351호",
        "subject": "[C공구(철도)] 제1차 1회 준공기한 연장 계약변경 요청",
        "sender": "계약상대자",
    ...
    # ─ 16. 제1차 3회 계약변경 요청 — 구 no.20
    {
        "no": 16,
        "date": "2025.11.26.",
        "doc_number": "A건설(C공구) 제2025-0805호",
        "subject": "[C공구(철도)] 설계변경(제1차 3회)에 따른 계약변경 요청",
        "sender": "계약상대자",
    ...
    {
        "no": 18, "date": "2024.11.25.", "doc_number": "A건설(C공구) 제2024-0345호",
    ...
    {
        "no": 19, "date": "2024.11.25.", "doc_number": "A건설(C공구) 제2024-0346호",
    ...
    {
        "no": 24, "date": "2025.11.03.", "doc_number": "A건설(C공구) 제2025-0736호",
    ...
    },
    {
        ...
        "doc_number": "A건설(C공구) 제2024-0351호 첨부 공기연장 검토서",
    ...
    "detail_narratives": [
        {
            "paragraphs": [
                (
                    "계약상대자는 2024. 11. 27. 'A건설(C공구) 제2024-0351호' 공문을 통해 "
                    "본건 공사 중 제1차 공사의 준공기한 연장을 위한 제1회 계약변경 요청 "
                    "서류를 제출하며 계약기간 연장을 신청하였습니다. 동 공문 제출에 앞서 "
                    "계약상대자는 2024. 11. 25. A건설(C공구) 제2024-0345호 및 제2024-0346호를 "
                ...
                (
                    ...
                    "(문화재_B) 현상변경 허가(2024.03.15.), 국가지정문화재(수원 광주이씨고택) "
        ...
        },
        {
            "paragraphs": [
                (
                    "이후 계약상대자는 2025. 11. 26. 'A건설(C공구) 제2025-0805호' 공문을 통하여 "
