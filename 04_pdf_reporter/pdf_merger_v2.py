...
def has_leading_number(name: str) -> bool:
    """파일/폴더명 앞에 번호가 있는지 확인. '1. xxx', '1.2. xxx' 형태."""
    return bool(re.match(r'^\d+[.\s]', name))


# ──────────────────────────────────────────────
# 폴더 재귀 순회
# 번호 있으면 계층 번호 생성, 번호 없으면 이름만 그대로
# ──────────────────────────────────────────────
